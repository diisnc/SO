...
//vars globais
int nodes[500];//dps altera-se
int connects[500][500];
//(...)
...
int main(int argc, char **argv){
		...
		char buffer[PIPE_BUF];
		char **args;						/*Apontador para um array de 10 char*, devolvido pela parse_cmd.*/

		//inicializar os arrays globais a 0 ou -1(fazer)

		while (read_line(0, buffer, PIPE_BUF) > 0) {		/*Lê um comando de tamanho até PIPE_BUF de cada vez.*/
